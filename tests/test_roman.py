'''
Test suite for roman.py - follow TDD example in DIP.
I try to boost things up a bit with nose as well - let's see
how that goes.
'''
from nose.tools import *
import pyexp.roman as roman
import unittest
...
class ToRomanBadInput(unittest.TestCase):
    ...
    def test_too_small(self):
        ...
        self.assertRaises(roman.OutOfRangeError, roman.to_roman, -1000)

    def test_non_integer(self):
        self.assertRaises(roman.NotIntegerError, roman.to_roman, 1.1)
        self.assertRaises(roman.NotIntegerError, roman.to_roman, str(1))
